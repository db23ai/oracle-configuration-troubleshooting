...
Oracle Database clone files are available in the repository. To list available patches, use the following command:
...
Connect to the DB system and update the DCS admin:
...
Registering working copy                 servername             February 03, 5 06:23:25 CET           February 03, 2025 06:23:26 CET           Success         
...
Run the following command to apply the server update:
...
PreRebootNode Actions                    servername             February 03, 2025 07:11:55 CET           February 03, 2025 07:12:20 CET           Success         
Reboot Node                              servername             February 03, 2025 07:12:21 CET           February 03, 2025 07:12:21 CET           Success         

9. Database Patching Pre-checks

Run the following command to create a pre-patch report:
...
Run the following command to describe the pre-patch report:
...
Node Name: servername-node0
Pre-Check 	Status 	Comments
Validate DB Home ID 	Success 	Validated DB Home ID: b4550202-0bb2-4fee-96a4-b4373b0e24cf
Validate patching tag 	Success 	Validated patching tag: 19.25.0.0.0.
Is system provisioned 	Success 	Verified system is provisioned
Validate minimum agent version 	Success 	Validated minimum agent version
Is GI upgraded 	Success 	Validated GI is upgraded
Validate available space for db 	Success 	Validated free space required under /u01
Validate glogin.sql file 	Success 	Successfully verified glogin.sql won't break patching
Is DB clone available 	Success 	Successfully validated clone file exists
Evaluate DBHome patching with RHP 	Success 	Successfully validated updating dbhome with RHP and local patching is possible
Validate command execution 	Success 	Validated command execution
Node Name: servername-node1
Pre-Check 	Status 	Comments
Validate DB Home ID 	Success 	Validated DB Home ID: b4550202-0bb2-4fee-96a4-b4373b0e24cf
Validate patching tag 	Success 	Validated patching tag: 19.25.0.0.0.
Is system provisioned 	Success 	Verified system is provisioned
...
Run the following command to update DBHOME:
